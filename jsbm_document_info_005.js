...
function()
{
    ...
    function documentInfoGetAndShow()
    {
        ...
        infoDiv.addEventListener("click", function() { moveDown(mainDivId.id); });

        infoDiv.addEventListener("contextmenu", function() { elementRemove(mainDivId.id); });
