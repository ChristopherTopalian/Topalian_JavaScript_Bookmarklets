...
/* jsbm_elements_info_and_styled_006.js */
/*
...
in this script, it only shows the location of the document once
*/
...
function()
{
    ...
    function elementInfoShowLocation(whichItem)
    {
        console.log(elementInfoGet(whichItem).theLocation);
    }

    function elementInfoShowItem(whichItem)
    {
    ...
    function elementInfoAndStyled(elementType)
    {
        ...
        for (let x = 0; x < theElements.length; x++)
        {
            ...
            elementInfoShowItem(theElements[x]);

            elementStyle(theElements[x]);
        }

        elementInfoShowLocation(theElements[0]);
